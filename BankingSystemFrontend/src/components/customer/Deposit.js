// --- src/components/customer/Deposit.js ---
...
const Deposit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSuccess(`Successfully deposited $${parseFloat(amount).toFixed(2)}. New balance: $${response.data.newBalance.toFixed(2)}`);
      setAmount('');
      setDescription('');
  ...
  return (
    <div className="w-full max-w-lg mx-auto bg-white p-8 rounded-lg shadow-lg">
      <h2 className="text-3xl font-bold text-center text-gray-800 mb-6">Make a Deposit</h2>
